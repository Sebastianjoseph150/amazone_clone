import 'dart:convert';
// import 'package:amazone_clone/data/functions/movies_function.dart';
import 'package:amazone_clone/data/functions/movies_funtions.dart';
import 'package:amazone_clone/data/model/GetModel.dart';
import 'package:amazone_clone/pages/detailsPages/tv_details.dart';
          ...
          child: GestureDetector(
            onTap: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        TvDetailsPage(index: index, list: list),
                  ));
            },
            child: Container(
              height: 250,
